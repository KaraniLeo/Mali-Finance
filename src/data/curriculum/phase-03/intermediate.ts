...
export const intermediateLesson: Lesson = {
  ...
  cards: [
    ...
    { id: 'i5', type: 'exercise', title: 'Correlation Check', content: 'Which two assets likely have a Negative Correlation (-1)?', options: ['Apple and Microsoft.', 'An S&P 500 Index Fund and a Gold ETF.', 'ExxonMobil and Chevron.'], correctAnswer: 'An S&P 500 Index Fund and a Gold ETF.'
    },
    ...
    { id: 'i12', type: 'concept', title: 'The VIX (Volatility Index)', content: 'The VIX is the "Fear Gauge" of the stock market. It measures the amount of Put Options (crash insurance) institutions are buying on the S&P 500.'
    },
    ...
    { id: 'i21', type: 'warning', title: 'The Retirement Trap', content: 'If you retire and the stock market crashes 40% in your first year, and you are forced to sell stocks to buy groceries at the absolute bottom, you will run out of money before you die. This is Sequence Risk.'
    },
    ...
    { id: 'i23', type: 'concept', title: 'Beta', content: 'Beta measures how volatile a stock is compared to the overall market. The market (S&P 500) has a Beta of 1.0.'
    },
    ...
    { id: 'i30', type: 'concept', title: 'Live Scenario', content: 'Test your understanding of Correlation and Hedging in a live dynamic scenario.', tool: 'dynamic',
      toolProps: {
        ...
        choices: [
          ...
          { text: "Buy $20,000 worth of S&P 500 Put Options as a hedge.", result: 150000, feedback: "Masterful execution! The market crashed 30%. Your tech stocks lost $300k, but your Put Options skyrocketed in value by $450k due to the VIX spike. You actually netted a $150k profit during a market crash." },
