...
export const proLesson: Lesson = {
  ...
  cards: [
    ...
    { id: 'p5', type: 'example', title: 'Step-by-Step Execution (DCF Model)', content: '- Step 1: Find the company\'s Current Free Cash Flow (FCF).\n- Step 2: Project FCF growth for the next 5-10 years.\n- Step 3: Determine a "Discount Rate" (usually 8-12%).\n- Step 4: Discount each projected future cash flow back to Year 0.\n- Step 5: Calculate the "Terminal Value" and discount it back to Year 0.\n- Step 6: Add them all up (Intrinsic Value of the total company).\n- Step 7: Divide by the number of Shares Outstanding to get Fair Value Price per share. If trading 30% below, buy.'
    },
    ...
    { id: 'p11', type: 'concept', title: 'Weighted Average Cost of Capital (WACC)', content: 'When selecting your Discount Rate, professional analysts use WACC. It calculates exactly how much it costs the company to fund itself via a mix of Debt ({{INTERNATIONAL:interest rates|KENYA:interest rates (CBR)}}) and Equity.'
    },
    { id: 'p12', type: 'insight', title: 'Interest Rate Gravity', content: 'When the Central Bank raises {{INTERNATIONAL:interest rates|KENYA:interest rates (CBR)}}, the WACC (Discount Rate) goes UP.\n\nMathematically, when you divide future cash flows by a higher discount rate, the Intrinsic Value drops. This is why stocks crash when {{INTERNATIONAL:interest rates|KENYA:interest rates (CBR)}} rise.'
    },
    ...
    { id: 'p15', type: 'exercise', title: 'Gravity Check', content: 'If {{INTERNATIONAL:interest rates|KENYA:interest rates (CBR)}} rise to 10%, what happens to the intrinsic value of future cash flows?', options: ['They become more valuable.', 'They become less valuable.', 'They remain unchanged.'], correctAnswer: 'They become less valuable.'
    },
    ...
    { id: 'p17', type: 'insight', title: 'Automating Value', content: 'Buying the top 30 ranked stocks in the Magic Formula historically crushes the {{INTERNATIONAL:S&P 500 index|KENYA:NSE 20 Share Index}}, because it mechanically forces you to buy "Good companies at Cheap prices".'
    },
    { id: 'p18', type: 'concept', title: 'Net Net Stocks', content: 'Benjamin Graham (Buffett\'s mentor) used to buy "Cigar Butts". These were companies trading below their Net Current Asset Value.\n\nBasically, the cash in their {{INTERNATIONAL:bank account|KENYA:bank account or M-PESA wallet}} was worth more than the entire stock price.'
    },
    ...
    { id: 'p26', type: 'warning', title: 'The Value Trap - Leadership', content: 'Sometimes a spreadsheet says a company is worth $100, and it trades at $50. But the CEO is corrupt and slowly siphoning cash out through massive salaries. The math works, but the qualitative analysis fails. You still lose money.'
    },
