...
export const proLesson: Lesson = {
  ...
  cards: [
    ...
    { id: 'p5', type: 'exercise', title: 'Fiat Logic', content: 'What gives Fiat money its value?', options: ['Gold in the {{INTERNATIONAL:Federal Reserve|KENYA:Central Bank of Kenya (CBK)}}.', 'Mathematical scarcity.', 'Government decree and collective human trust.'], correctAnswer: 'Government decree and collective human trust.'
    },
    ...
    { id: 'p9', type: 'concept', title: 'The Debt Supercycle', content: 'Ray Dalio popularized the concept of the Long-Term Debt Cycle. Every 75-100 years, debt builds up so massively in the system that {{INTERNATIONAL:interest rates|KENYA:interest rates (CBR)}} hit 0%, and the only way out is for the Central Bank to devalue the currency to pay off the debt.'
    },
    ...
    { id: 'p12', type: 'concept', title: 'Financial Repression', content: 'This occurs when the government artificially caps {{INTERNATIONAL:interest rates|KENYA:interest rates (CBR)}} below the rate of inflation.\n\nIf inflation is 5%, but the bank only pays you 1%, the government is essentially stealing 4% of your wealth every year to pay off its own debt.'
    },
    ...
    { id: 'p30', type: 'concept', title: 'Live Scenario', content: 'Test your understanding of the Fiat Standard and the Cantillon Effect in a live dynamic scenario.', tool: 'dynamic',
      toolProps: {
        scenario: "The year is 2020. A global crisis hits. The Central Bank announces they will print $4 Trillion and inject it into the banking system (Quantitative Easing). You have $100,000 in your {{INTERNATIONAL:bank account|KENYA:bank account or M-PESA wallet}}.",
        ...
        choices: [
          ...
          { text: "Immediately deploy the cash into scarce assets (Real Estate, {{INTERNATIONAL:S&P 500 index|KENYA:NSE 20 Share Index}}, Bitcoin).", result: 50000, feedback: "Perfect execution. You understood the Cantillon Effect. The printed trillions flooded into the banks, who lent it to hedge funds, who bought assets. By front-running this liquidity, your portfolio skyrocketed 50%." },
          { text: "Buy Long-Term {{INTERNATIONAL:government bonds|KENYA:Treasury Bonds (T-Bonds) or Infrastructure Bonds}}.", result: -15000, feedback: "The massive money printing eventually caused high inflation, forcing the Central Bank to raise {{INTERNATIONAL:interest rates|KENYA:interest rates (CBR)}} two years later. The value of your low-interest bonds was crushed." }
        ]
      }
    }
  ]
