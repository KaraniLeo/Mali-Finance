...
export const intermediateLesson: Lesson = {
  ...
  cards: [
    ...
    { id: 'i3', type: 'concept', title: 'Quantitative Easing (QE)', content: 'When the economy is crashing and lowering interest rates to 0% isn\'t enough, the Central Bank uses Quantitative Easing.\n\nThey magically create trillions of digital dollars and use them to buy government bonds and mortgage-backed securities from banks.'
    },
    { id: 'i4', type: 'example', title: 'The Wealth Effect', content: 'By injecting trillions of dollars into the banks, the banks have excess cash. They lend it out cheaply. This cash floods into the stock market and real estate, pumping asset prices to all-time highs.'
    },
    { id: 'i5', type: 'exercise', title: 'The QE Result', content: 'What is the immediate effect of massive Quantitative Easing (money printing)?', options: ['The stock market crashes.', 'Asset prices (stocks, real estate) skyrocket due to massive liquidity injections.', 'Deflation occurs.'], correctAnswer: 'Asset prices (stocks, real estate) skyrocket due to massive liquidity injections.'
    },
    ...
    { id: 'i8', type: 'insight', title: 'The Liquidity Drain', content: 'When QT happens, the stock market panics. It is like draining water from a pool; all the boats (stocks) sink.'
    },
    { id: 'i9', type: 'concept', title: 'The Yield Curve', content: 'The Yield Curve is a chart showing the interest rates of different government bonds (like the 2-year Treasury vs the 10-year Treasury).'
    },
    ...
    { id: 'i16', type: 'example', title: 'Inverse Correlation', content: 'When the DXY goes up rapidly, the stock market and Bitcoin usually go down. When the DXY drops, risk assets soar.'
    },
    { id: 'i17', type: 'exercise', title: 'DXY Logic', content: 'If the DXY (US Dollar Index) is rapidly skyrocketing, what typically happens to the stock market?', options: ['It crashes.', 'It moons.', 'It stays perfectly flat.'], correctAnswer: 'It crashes.'
    },
    ...
    { id: 'i21', type: 'insight', title: 'CPI Day', content: 'The day CPI data is released is one of the most volatile days in the stock market. If inflation comes in higher than expected, the market instantly crashes because it means the Central Bank will raise interest rates.'
    },
    ...
    { id: 'i23', type: 'example', title: 'Bad News is Good News', content: 'During high inflation, if the NFP report says "100,000 people lost their jobs", the stock market might actually GO UP. Why? Because terrible job numbers mean the Central Bank might lower interest rates to save the economy.'
    },
    { id: 'i24', type: 'exercise', title: 'Market Logic', content: 'Why would the stock market rally on terrible unemployment data?', options: ['Because investors hate workers.', 'Because bad data means the Central Bank might lower interest rates and print money to save the economy.', 'Because the data is fake.'], correctAnswer: 'Because bad data means the Central Bank might lower interest rates and print money to save the economy.'
    },
    ...
    { id: 'i27', type: 'concept', title: 'Global Liquidity', content: 'The stock market is essentially just a sponge that absorbs global liquidity. When central banks across the world are printing money, stocks go up regardless of how bad company earnings are.'
    },
    ...
    { id: 'i30', type: 'concept', title: 'Live Scenario', content: 'Test your understanding of Macroeconomic data releases in a live dynamic scenario.', tool: 'dynamic',
      toolProps: {
        ...
        choices: [
          { text: "Buy the dip! Stocks always go up.", result: -3000, feedback: "You got crushed. 5.5% inflation means the Central Bank is going to violently raise interest rates and destroy liquidity. The market crashed 4% instantly." },
          { text: "Short the market, or move entirely to Cash.", result: 2000, feedback: "Perfect Macro reading. You knew that high inflation forces the Central Bank to raise interest rates, which acts like gravity on stock prices. You protected your capital." },
          { text: "Buy Long-Term Government Bonds.", result: -1500, feedback: "Terrible idea. When interest rates rise to fight inflation, the value of existing low-interest bonds crashes." }
        ]
      }
    }
  ]
