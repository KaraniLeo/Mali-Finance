...
export const beginnerLesson: Lesson = {
  ...
  cards: [
    ...
    { id: 'b5', type: 'concept', title: 'Credit is Money', content: 'Most of the "money" in the world isn\'t physical cash. It is Credit (debt). When you swipe a {{INTERNATIONAL:credit card|KENYA:credit card or Fuliza/M-Shwari limit}}, you are literally creating new money out of thin air based on a promise to pay it back.'
    },
    ...
    { id: 'b9', type: 'concept', title: 'The Central Bank (The Fed)', content: 'The {{INTERNATIONAL:Federal Reserve|KENYA:Central Bank of Kenya (CBK)}} (The Fed) is the central bank of the United States. It does not print physical cash. Its main job is to control the flow of Credit in the economy using {{INTERNATIONAL:interest rates|KENYA:interest rates (CBR)}}.'
    },
    { id: 'b10', type: 'example', title: 'The Gas Pedal', content: 'If the economy is crashing (Recession), the Fed lowers {{INTERNATIONAL:interest rates|KENYA:interest rates (CBR)}} to 0%. Borrowing money becomes incredibly cheap. People borrow to buy houses, companies borrow to hire workers. The economy booms. This is "Stimulus".'
    },
    { id: 'b11', type: 'warning', title: 'The Brake Pedal', content: 'If the economy grows too fast, Inflation happens (prices skyrocket). The Fed raises {{INTERNATIONAL:interest rates|KENYA:interest rates (CBR)}}. Borrowing money becomes very expensive. People stop spending, companies fire workers, and prices drop. This causes pain, but kills inflation.'
    },
    { id: 'b12', type: 'exercise', title: 'Central Banking', content: 'What tool does the Central Bank use to slow down an overheating, inflationary economy?', options: ['They lower {{INTERNATIONAL:interest rates|KENYA:interest rates (CBR)}} to 0%.', 'They raise {{INTERNATIONAL:interest rates|KENYA:interest rates (CBR)}}, making borrowing expensive and forcing people to stop spending.', 'They ban people from buying groceries.'], correctAnswer: 'They raise {{INTERNATIONAL:interest rates|KENYA:interest rates (CBR)}}, making borrowing expensive and forcing people to stop spending.'
    },
    ...
    { id: 'b17', type: 'warning', title: 'The Silent Thief', content: 'If you keep $10,000 in a {{INTERNATIONAL:savings account|KENYA:savings account or SACCO deposit}} paying 1% interest, but inflation is 5%, you are losing 4% of your purchasing power every single year. You are bleeding wealth while doing nothing.'
    },
    ...
    { id: 'b24', type: 'exercise', title: 'The Dual Mandate', content: 'What are the two primary, often conflicting, goals of the {{INTERNATIONAL:Federal Reserve|KENYA:Central Bank of Kenya (CBK)}}?', options: ['To print money and buy Bitcoin.', 'To keep inflation low while also maximizing employment.', 'To help the {{INTERNATIONAL:stock market|KENYA:Nairobi Securities Exchange (NSE) or global markets}} go up.'], correctAnswer: 'To keep inflation low while also maximizing employment.'
    },
    { id: 'b25', type: 'concept', title: 'Fiscal Policy vs Monetary Policy', content: 'Monetary Policy = The Fed changing {{INTERNATIONAL:interest rates|KENYA:interest rates (CBR)}}. Fiscal Policy = The Government passing laws to tax people or spend money (like stimulus checks).'
    },
    { id: 'b26', type: 'insight', title: 'The Stimulus Bomb', content: 'In 2020, the Fed dropped {{INTERNATIONAL:interest rates|KENYA:interest rates (CBR)}} to 0% (Monetary), AND the Government handed out trillions in free checks (Fiscal). This massive injection of money into a closed economy caused the highest inflation in 40 years.'
    },
    ...
    { id: 'b30', type: 'concept', title: 'Live Scenario', content: 'Test your understanding of {{INTERNATIONAL:interest rates|KENYA:interest rates (CBR)}} and Inflation in a live scenario.', tool: 'dynamic',
      toolProps: {
        scenario: "Inflation just hit 9%. A loaf of bread costs $10. The {{INTERNATIONAL:Federal Reserve|KENYA:Central Bank of Kenya (CBK)}} announces an emergency meeting. You hold $50,000 in high-growth, unprofitable tech stocks.",
        startingBalance: 50000,
        choices: [
          { text: "Hold the stocks. High inflation means prices go up, so the stock prices will go up too!", result: -30000, feedback: "You failed to anticipate the Fed's reaction. To kill the 9% inflation, the Fed violently raised {{INTERNATIONAL:interest rates|KENYA:interest rates (CBR)}}. High rates crush unprofitable tech companies because borrowing money to survive becomes too expensive. Your stocks crashed." },
          { text: "Sell the tech stocks immediately and move to cash or short-term Treasury bonds.", result: 5000, feedback: "Pro execution. You knew 9% inflation would force the Fed to raise rates. Rising rates crush risky stocks but make safe, short-term {{INTERNATIONAL:government bonds|KENYA:Treasury Bonds (T-Bonds) or Infrastructure Bonds}} highly attractive. You protected your capital." },
