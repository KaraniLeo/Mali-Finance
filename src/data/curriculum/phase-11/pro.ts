...
export const proLesson: Lesson = {
  ...
  cards: [
    ...
    { id: 'p19', type: 'concept', title: 'Systematic Trading (Algos)', content: '80% of volume on the {{INTERNATIONAL:stock market|KENYA:Nairobi Securities Exchange (NSE) or global markets}} is generated by algorithms (robots), not humans. They do not feel fear. They do not feel greed. They execute math.'
    },
