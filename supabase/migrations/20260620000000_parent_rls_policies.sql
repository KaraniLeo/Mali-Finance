...
-- Create RLS policies for parental controls
-- 1. Profiles Update Policy (Allow parents to update child balances/streaks/limits)
...
-- 2. Wallets Policies (Allow parents to view/update child wallets)
...
-- 3. Wealth Jars Policies (Allow parents to view child wealth jars)
...
-- 4. Budget Rules Policies (Allow parents to view child budget rules)
...
-- 5. Transactions Policies (Allow parents to view and insert transactions for children)
...
-- 6. Debts Policies (Allow parents to view child debts)
...
-- 7. User Tasks Policies (Allow parents to view and manage child tasks)
